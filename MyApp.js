...
import { StyleSheet, Text, View, Image, TextInput, Button, SafeAreaView, TouchableHighlight } from 'react-native';
...
const DisplayTextInputAndButton = () => {
    ...
    return (
        <View style={styles.imageWrapper}>
            ...
            <Button title='Press Me' style={styles.trueButtons}></Button>
        </View>
    );
};
